...
const guardar = async (e) => {
    ...
    try {
        ...
        const url = '/base/API/productos/guardar';
...
const Buscar = async () => {
    ...
    const url = '/base/API/productos/buscar';
...
const llenarDatos = (productos) => {
    ...
    formulario.producto_nombre.value = productos.prod_nombre;
...
const Modificar = async (e) => {
    ...
    try {
        const body = new FormData(formulario)
        const url = '/base/API/productos/modificar';
...
const Eliminar = async (productos) => {
    ...
    if (confirmacion.isConfirmed) {
        ...
        try {
            ...
            const url = '/base/API/productos/eliminar';
            const config = {
                method: 'POST',
                body
            }
