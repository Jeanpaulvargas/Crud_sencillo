...
const guardar = async (e) => {
    ...
    try {
        ...
        const url = '/base/API/aplicacion/guardar';
...
const Buscar = async () => {
    ...
    const url = '/base/API/aplicacion/buscar';
    ...
    if (data.length > 0) {
        ...
        data.forEach(app => {
            ...
            BtnModificar.innerHTML = '<i class="bi bi-gear"></i>';
...
const Modificar = async (e) => {
    ...
    try {
        const body = new FormData(formulario)
        const url = '/base/API/aplicacion/modificar';
...
const Eliminar = async (aplicacion) => {
    ...
    if (confirmacion.isConfirmed) {
        ...
        try {
            ...
            const url = '/base/API/aplicacion/eliminar';
            const config = {
                method: 'POST',
                body
            }
